...
def get_symbol(num_classes):
    ...
    fc1 = mx.symbol.FullyConnected(data=flatten, num_hidden=num_classes, name='fcn1')  # renamed from fc1
    softmax = mx.symbol.LogisticRegressionOutput(data=fc1, name='softmax')
    return softmax
